...
export class User extends BaseEntity {
  ...
  declare employeeProfiles: Employee[];
  ...
  declare ordersCreatedByEmployee: Order[];
  ...
  get isEmployee(): boolean {
    return [UserRole.EMPLOYEE, UserRole.MANAGER, UserRole.ADMIN, UserRole.OWNER,
            UserRole.CASHIER, UserRole.BARISTA, UserRole.KITCHEN, UserRole.WAITER].includes(this.role);
  }
}
