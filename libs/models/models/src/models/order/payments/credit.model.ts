...
import { CreditRestrictions } from './credit-restrictions.model';
...
export class Credit extends BaseEntity {
  ...
  @OneToOne(() => CreditRestrictions, restrictions => restrictions.credit, { cascade: true })
  declare restrictions: Relation<CreditRestrictions>;
